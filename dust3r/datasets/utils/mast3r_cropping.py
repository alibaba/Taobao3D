...
def extract_correspondences_from_pts3d(view1, view2, target_n_corres, rng=np.random, ret_xy=True, nneg=0):
    ...
    # check valid according to valid_mask
    view1_valid_mask = view1['valid_mask'].reshape(-1)
    pos1_valid_mask = view1_valid_mask[pos1]
    view2_valid_mask = view2['valid_mask'].reshape(-1)
    pos2_valid_mask = view2_valid_mask[pos2]
    valid = valid & pos1_valid_mask & pos2_valid_mask
