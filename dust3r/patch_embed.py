...
class ManyAR_PatchEmbed (PatchEmbed):
    ...
    def forward(self, img, true_shape, atm_size=None):
        B, C, H, W = img.shape
        ...
        # note: self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size)
        # note: landscape[w>h], portrait[w<h], img: BCHW, 0231 -> BHWC, swapaxes+0231 -> BWHC
